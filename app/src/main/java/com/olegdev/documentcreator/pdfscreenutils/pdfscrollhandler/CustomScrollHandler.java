package com.olegdev.documentcreator.pdfscreenutils.pdfscrollhandler;
...
public class CustomScrollHandler extends RelativeLayout implements ScrollHandle {
    ...
    public CustomScrollHandler(Context context, boolean inverted) {
        ...
        setTextColor(ContextCompat.getColor(context, R.color.color_text_scroll_handler));
        setTextFont(ResourcesCompat.getFont(context, R.font.josefin_sans_semibold));
    ...
    public void setupLayout(PDFView pdfView) {
        ...
        if (pdfView.isSwipeVertical()) {
            ...
            if (inverted) { // left
                ...
                background = ContextCompat.getDrawable(context, R.drawable.scroll_handler);
            }
        } else {
            width = HANDLE_SHORT;
            height = HANDLE_LONG;
            if (inverted) { // top
                ...
                background = ContextCompat.getDrawable(context, R.drawable.scroll_handler_bottom);
            }
        }

        setBackground(background);

        RelativeLayout.LayoutParams lp = new LayoutParams(Util.getDP(context, width), Util.getDP(context, height));
